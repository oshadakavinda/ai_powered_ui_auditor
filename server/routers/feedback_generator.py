...
from server.config import UPLOAD_DIR, WEIGHTS_DIR
...
async def generate_feedback(
    ...
    try:
        ...
        # Execute pipeline
        yolo_path = os.path.join(str(WEIGHTS_DIR), "best3.pt")
...
async def get_feedback_image(report_id: str):
    ...
    # Try PNG first (new pipeline), then JPG (legacy)
    for ext, media in [(".png", "image/png"), (".jpg", "image/jpeg")]:
        report_path = os.path.join(str(UPLOAD_DIR), f"{report_id}{ext}")
